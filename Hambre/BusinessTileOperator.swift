...
class BusinessTileOperator: NSObject {
    ...
    public init(anArrayOfBusinesses: [YLPBusiness], city: String, state: String)
    {
        ...
        for business in anArrayOfBusinesses
        {
            ...
            {
                let personalBusiness = PersonalBusiness(businessName: business.name, businessImageUrl: business.imageURL!, city: city, state: state, liked: false, likes: 0)
            ...
            {
                let personalBusiness = PersonalBusiness(businessName: business.name, businessImageUrl: URL(string: "https://upload.wikimedia.org/wikipedia/commons/5/59/Facultat_Filosofia_URL.JPG")!, city: city, state: state, liked: false, likes: 0)
